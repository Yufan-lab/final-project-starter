  ...
  render() {
      ...
      return (
          <section style={{ height: courseHeight, width: courseWidth }} className={styles.coursesTable} onContextMenu={e => e.preventDefault()}>
              <div ref={e => {
                  this.courseWrapper = e; 
              }} className={styles.courseWrapper} style={{ height: "100%", width: "100%" }}>
                  ...
                  <div ref={(e) => {
                      this.coursesContent = e; 
                  }} className={styles.coursesContent} style={{ width: courseWidth }}>
                      {contentItemWidth ? 
                          renderWeek().map((item, index) => {
                  ...
                  }} style={{ width: 66 }} className={styles.coursesLeftHand}>
                      {
